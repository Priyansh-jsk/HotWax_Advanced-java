...
<body>
	<!-- <div align="center"> -->
	<div align="center" class="classtwo">
		<fieldset>
			...
			<form action="registration" method="Post" class="max">
				<table class="table-style">
					...
					<tr>
						<td>Zip</td>
						<td><input type="zip" name="zip"></td>
					</tr>
					<tr>
						<div>
							<td>Email</td>
							<td><input type="email" id="email" name="email"></td>
							<td><span style="color: yellow" id="emailerror">* <%
					...
					<tr>
						...
						<td><span style="color: yellow" id="passworderror">*</span></td>
					</tr>
					<tr>
						<td>Phone</td>
					...
					<tr>
						...
						<td><input class="btn" type="submit" onclick="alertfn()"
							value="Sign Up"></td>
